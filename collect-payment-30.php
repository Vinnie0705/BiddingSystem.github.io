...
$query = "SELECT n.thirty_price, b.proj_id, cp.cp_id, cp.cp_type, cp.cp_size, cp.cp_images, u.user_id AS client_id, u2.user_id AS cont_id, cp.package_id
          FROM notification n
...
$thirtyPrice = $notification['thirty_price'];
            ...
            <div class="details">
                ...
                <div class="card">
                    ...
                    <div class="info">
                        ...
                        <p>Price: RM<?= number_format((float) $thirtyPrice, 2, '.', ',') ?></p>
                    </div>
                </div>
            </div>
        ...
        if (input.files.length > 0) {
            ...
            if (fileType.includes("image")) {
                reader.onload = function (e) {
                    preview.innerHTML = `<img src="${e.target.result}" alt="Receipt Preview" width="150" 
                                         style="margin-top: 10px; border-radius: 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.2);">`;
                };
